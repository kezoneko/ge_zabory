...
--
-- Хост: localhost
-- Время создания: Дек 29 2016 г., 02:20
...
(1, 'KesГотовый забор «под ключ» уже через <span>5 дней</span><br>\r\nОт профессионалов с <span>9-летним</span> опытом<br>\r\nРассчитайте стоимость на сайте', 1, ''),
(2, 'Kes<span>В июле </span> скидки<br>на профнастил <span>10%</span>', 1, ''),
(3, 'Работаем по договору с гарантией сроков', 2, 'icon-contract'),
(4, 'asdfУстанавливаем до 100м забора в день', 2, 'icon-tools'),
...
(8, 'asdfЗа 9 лет произвели<br>и установили более<br>1093 км ограждений', 3, ''),
...
(2, 'asdfУзнайте всё о заборах<br>от нашего специалиста. Перезвоним за 5 минут!', 'aПолучить консультацию'),
